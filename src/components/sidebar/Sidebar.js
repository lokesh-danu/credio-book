        ...
        <div>
            <div className='sidebar'>
                ...
                <ul className='sidebar-menu-items'>
                    <Link to="/home">
                    <li className='sidebar-menu-item' style={{background: "#BC0018",
                        borderRadius:"20px", width: "200px", marginLeft: "-1rem"
                    }} >
                        <img src={Dash} alt="" style={{color: "white", marginTop: "-0.6rem", marginLeft: "0.5rem"}}/>
                        <span style={{color: "white", marginTop: "-4rem"}} className='sidebar-text'>Dashboard</span>
                    </li>
                    </Link>
                    <Link to="/transaction">
